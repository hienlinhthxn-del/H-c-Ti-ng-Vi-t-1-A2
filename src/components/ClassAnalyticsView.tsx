                        ...
                        >
                          ...
                          <td className="py-3.5 px-4">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-2xl bg-amber-100 flex items-center justify-center text-xl shadow-xs shrink-0">
                                {student.avatar}
                              </div>
                              <div>
          ...
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl border border-slate-100 animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-start justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-3xl bg-amber-100 text-3xl flex items-center justify-center shadow-xs">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 text-xs text-slate-500 mt-1">
                    ...
                    <span>•</span>
                    {getStatusBadge(selectedStudentDetail.status)}
                  </div>
                </div>
              </div>
